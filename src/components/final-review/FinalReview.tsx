...
export function FinalReview({ specification, revision, mode, finalized, brainModel, realtimeModel, staleDecisionSummaries = [], onNextActionsChange, onFinalize, onResume, onExit }: { specification: Specification; revision: number; mode: SessionMode; finalized: boolean; brainModel?: string | null; realtimeModel?: string | null; staleDecisionSummaries?: DecisionSummary[]; onNextActionsChange: (actions: NextAction[]) => void; onFinalize: () => void; onResume: () => void; onExit: () => void }) {
