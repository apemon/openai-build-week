...
export function FinalReview({ specification, revision, mode, finalized, brainModel, realtimeModel, staleDecisionSummaries = [], persistentBrainStatus, decisionTray, experimental, onNextActionsChange, onFinalize, onResume, onExit }: { specification: Specification; revision: number; mode: SessionMode; finalized: boolean; brainModel?: string | null; realtimeModel?: string | null; staleDecisionSummaries?: DecisionSummary[]; persistentBrainStatus?: ReactNode; decisionTray?: ReactNode; experimental?: { adapter: BrainHarnessMode; publicSearchEnabled: boolean } | null; onNextActionsChange: (actions: NextAction[]) => void; onFinalize: () => void; onResume: () => void; onExit: () => void }) {
