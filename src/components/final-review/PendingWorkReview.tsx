...
export function PendingWorkReview({ pendingRequest, activeLookahead, staleSummaries, persistentBrainStatus, decisionTray, onAbandonAndReview, onKeepWorking }: PendingWorkReviewProps) {
